...
## Exercises
1. N-Multi-Back: using short-term memory and working memory to classify images/words in N-Back mode.
...
The brain often tries to get happiness hormones for itself, but thinks about the body infrequently. A person may eat tasty but unhealthy food. 
